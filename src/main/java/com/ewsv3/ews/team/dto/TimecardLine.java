...
public class TimecardLine {
    ...
    public String toString() {
        return "TimecardLine{" +
                ...
                ", timecardActuals=" + timecardActuals +
                '}';
    }
}
