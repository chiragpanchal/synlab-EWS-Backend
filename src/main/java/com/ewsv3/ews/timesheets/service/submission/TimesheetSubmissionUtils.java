...
public class TimesheetSubmissionUtils {
    ...
    public static String sqlGetTimesheetApprovals = """
            ...
            --    per_to.full_name   to_user,
                ...
                decode(si.completion_date, null , per_to.full_name || ' ('||per_to.employee_number||')' ,  decode(per_from.user_id,per_to.user_id,null,  per_to.full_name || ' ('||per_to.employee_number||')') )to_user,
                sn.status,
                sn.role_name,
                wc.comments,
